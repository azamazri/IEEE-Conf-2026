...
Collaborative and knowledge-graph recommenders---LightGCN, KGIN, and KGAT
\cite{r18,r19,r20}---take a user--item interaction matrix $R\in\{0,1\}^{U\times I}$ and
learn embeddings from it. The
